            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    infoFn: (params) => `در حال نمایش از ${params.firstRecordOnPage} تا ${params.lastRecordOnPage} در صفحه ${params.currentPage}`,
                                    ...
                                    <div slot="selected-row-actions" class="left">
                                        <button @click="deleteRow">حذف</button>
                                    </div>
                                    <template slot="table-row" slot-scope="props">
                      <span v-if="props.column.field === 'actions'">
<!--                         <button @click="editRow(props.row.actions)" class="btn btn-info" title="ویرایش دانش آموز">
    ...
    export default {
        ...
        methods: {
            getAllStudents(courseId) {
                Vue.http.get('api/admin/course-students/' + courseId).then(response => {
                    Swal.fire("مدیریت محترم اطلاعات دانش آموزان در حال بارگزاری می باشد! لطفا چند لحظه صبر کنید!", 'info');
            ...
            deleteRow(id, index) {
                 Swal.fire({
                    ...
                    if(result.value) {
                        Vue.http.delete('api/admin/student/student-delete/' + id).then(response => {
        ...
        created() {
            this.getAllStudents(this.$route.params.id);
