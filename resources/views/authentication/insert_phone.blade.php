...
<head>
    <meta charset="utf-8" />
    <title>بررسی شماره موبایل | آکادمی تخصصی تیزهوشان علم برتر سالار</title>
            ...
            <div class="col-xl-5 col-sm-8">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="p-2">
                            <h5 class="mb-5 text-center">شماره موبایل</h5>
                            <form class="form-horizontal" method="get" action="{{ route('user.send.sms.phone',['pc'=>$pc]) }}">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success btn-block waves-effect waves-light" type="submit">ارسال کد فعال سازی </button>
                                        </div>
                                    </div>
                                </div>
                            </form>
