...
@section('page_title')ناحیه کاربری@endsection
@section('content')
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                <h1 class="header-title">اطلاعات کاربری من</h1>
                                <!-- Nav tabs -->
                                                ...
                                                <div class="col-sm-8 text-xs-center text-md-left">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table ">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-xs-right"> <b>
                                                                        ...
                                                                        if (auth()->user()->avatar == null){
                                                                            $msg="تصویر پروفایل خود را آپدیت کنید!";
                                                                        }elseif (auth()->user()->avatar_check == 0){
                                                                            $msg="منتظر تایید ادمین باشید!";
                                                                        }elseif (auth()->user()->avatar_check == 1){
                                                                            $msg="تصویر پروفایل تایید شده است!";
                                                                        }
                                                                        ?>
                                                                        {{ $msg }}
                                                                    </b></td>
                                                            ...
                                                            <tr>
                                                                <td>کد کاربری</td>
                                                                <td class="text-xs-right"><b>{{ auth()->user()->usercode == null ? 'نا مشخص' :  auth()->user()->usercode }}</b></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                <td>کلاس</td>
                                                                <td class="text-xs-right">
                                                                    <b>{{ auth()->user()->studentBaseClass->educationclass->class_title }}</b>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                    ...
                                                    <br>
                                                    <div class="btn-group">
                                                        <a href="{{ route('student.panel.edit') }}" class="btn btn-info"> <span>ویرایش اطلاعات</span> <i class="ti ti-pencil ::before"></i> </a>
                                                    </div>
