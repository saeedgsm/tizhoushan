            ...
            <div class="page-title-box">
                ...
                <div class="container-fluid bg-white mt-1"
                    ...
                    <div class="row py-4" style="font-size: 14px">
                        ...
                        <div class="col-6 col-md-3 my-2">
                            <p class="mb-0">زمان آزمون: <span class="font-weight-bold">{{ $azmoon->azmoon_time }}
                                    دقیقه</span></p>
                        </div>
                        ...
                        <div class="col-12 col-md-12 my-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <a href="{{ route('student.azmoons.karnameh', $azmoon) }}" style="margin-right: auto;"
...
`;
    ...
    <script type="text/javascript">
       ...
       /*  window.onbeforeunload = function() {
            Swal.fire({
                    title: 'اخطار',
                    text: 'دانش آموز عزیز اگر صفحه را رفرش کنید از آزمون خارج می شوید!',
                    icon: 'error',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
