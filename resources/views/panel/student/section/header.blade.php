        ...
        <div class="container-fluid">
            ...
            <div class="float-right">
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <!-- item-->
                        <a class="dropdown-item" href="{{ route('student.panel') }}"><i class="mdi mdi-face-profile font-size-16 align-middle mr-1"></i> اطلاعات کاربری</a>
            ...
            <div class="navbar-brand-box">
                <a href="/" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('imgs/logo-panel.png') }}" alt="" height="64">
                                </span>
                    <span class="logo-lg">
                                    <img src="{{ asset('imgs/logo-panel.png') }}" alt="" height="64">
                                </span>
            ...
            @include('panel.student.section.verticalMenu')
