...
@section('page_title')فرم نظرسنجی@endsection
@section('style')
            ...
            <div class="page-title-box">
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <h4 class="page-title mb-1">وقت نظرسنجی</h4>
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item active">نظرسنجی شروع شده است لطفا صفحه را نبندید!</li>
                            </ol>
                        </div>
                ...
                <div class="container-fluid bg-white mt-1"
                    ...
                    <div class="row py-4" style="font-size: 14px">
                        <div class="col-6 col-md-3 my-2">
                            <p class="mb-0">نام کاربر: <span class="font-weight-bold">{{ auth()->user()->first_name }}
                                    {{ auth()->user()->last_name }}</span>
                            </p>
                        </div>
                        <div class="col-6 col-md-4 my-2">
                            <p class="mb-0">نام نظرسنجی: <span class="font-weight-bold">{{ $survey->azmoon_title }}</span>
                            </p>
                        </div>
                        <div class="col-6 col-md-3 my-2">
                            <p class="mb-0">زمان نظرسنجی: <span class="font-weight-bold">{{ $survey->azmoon_time }}
                                    دقیقه</span></p>
                        </div>
                        <div class="col-6 col-md-2 my-2">
                            <p class="mb-0">تعداد سوال: <span class="font-weight-bold">{{ $soal->soal_count }} عدد</span>
                            </p>
                        </div>
                        <div class="col-12 col-md-12 my-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <button onclick=" endAzmoon()" id="btn-end" class="btn btn-danger btn-rounded">پایان
                                        نظرسنجی
                                    </button>
                                    <a href="{{ route('student.surveys.result', $survey) }}" style="margin-right: auto;"
                ...
                <div class="container-fluid bg-info mt-4"
                    style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 5px">
                    <h5 class="text-center text-white py-4">{{ $book->book_name }}</h5>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title"> برگه نظرسنجی</h5>

                                    <hr>
                                    <p class="card-title-desc">
                                        @include('alert_messages.alerts')
                                    </p>
                                    <input type="hidden" name="azmoon_id" value="{{ $survey->id }}">
    ...
    <script>
        ...
        for (let i of inpRadio) {
            i.addEventListener('click', function() {
                // counts of checked and unchecked !!
                var $radio = $(this);
                let lio = null;
                for (lio of $radio) {}
              ...
              //  map.get
                map.set(objForm.name, objForm.value)
                objForm.azmoon_id = {{ $survey->id }};
                objForm.user_id = {{ auth()->user()->id }};

                if (objForm.status === false) {
                    map.delete(objForm.name);
                }
                //console.log(map,objForm)
                /* axios.post('/student/azmoon/result/update', objForm)
        ...
        function endAzmoon() {
            ...
            form.addEventListener('submit', (e) => {
                ...
                let firstLineStr = "شما در حال نظرسنجی دادن هستید! برای خروج از نظرسنجی مطمئن هستید؟ ";
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        axios.post('/student/survey/end', formData)
                            .then(function(response) {
                                ...
                                window.addEventListener('beforeunload', function(e) {
                                    // Cancel the event
                                    console.log(   $(e.target) )// If you prevent default behavior in Mozilla Firefox prompt will always be shown
                                ...
                                window.location = "{{ route('student.surveys.result', $survey) }}";
        ...
        function endedAzmoon() {
            ...
            let firstLineStr = "نظرسنجی به پایان رسید! لطفا بروی پایان نظرسنجی کلیک کنید! ";
            let secondLineStr = "\r تعداد نزده : " + countUnchecked + " و تعداد زده شده: " + countChecked;
            let finalLine = firstLineStr + "\n" + secondLineStr;
            Swal.fire({
                title: mss,
                ...
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
                confirmButtonText: 'پایان نظرسنجی!',
                //cancelButtonText: 'خیر دستم خورد!',
            }).then((result) => {
                if (result.isConfirmed) {
                    axios.post('/student/survey/end', formData)
        ...
        function countdown(elementName, minutes, seconds) {
            ...
            function updateTimer() {
                ...
                if (msLeft < 1000) {
                    element.innerHTML = "پایان نظرسنجی";
                } else {
...
`;
    ...
    <script type="text/javascript">
       ...
       /*  window.onbeforeunload = function() {
            Swal.fire({
                    title: 'اخطار',
                    text: 'دانش آموز عزیز اگر صفحه را رفرش کنید از نظرسنجی خارج می شوید!',
                    icon: 'error',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#d33',
