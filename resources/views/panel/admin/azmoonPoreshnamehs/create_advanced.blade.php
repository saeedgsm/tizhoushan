                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active"><span>فرم افزودن گزینه سوال جدید برای آزمون</span> <span style="font-size: larger;color: white"> / {{ $azmoon->azmoon_title }} / {{ $book->book_name }}</span></li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.advanced.porseshnamehs.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="azmoon_id" value="{{ $azmoon->id }}">
                                    <input type="hidden" name="book_id" value="{{ $book->id }}">
                                    <?php for ($i=1;$i<=$request['soal_count'];$i++) { ?>
