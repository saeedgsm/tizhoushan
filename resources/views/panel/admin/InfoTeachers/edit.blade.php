...
@section('page_title') ویرایش اطلاعات استاد@endsection
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">ویرایش اطلاعات استاد</li>
                        </ol>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">ویرایش اطلاعات استاد</h4>
                                <p class="card-title-desc">
                                    @include('alert_messages.alerts')
                                </p>
                                <form action="{{ route('admin.teachers.update',$tcInfo) }}" method="post">
                                    @csrf
                                    @method('patch')
                                    <div id="user">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="first_name" type="text"
                                                           ...
                                                           name="first_name"
                                                           value="{{ old('first_name',$tcInfo->user->first_name) }}"
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="last_name" type="text"
                                                           ...
                                                           name="last_name"
                                                           value="{{ old('last_name',$tcInfo->user->last_name) }}"
                                                           placeholder="نام خانوادگی را وارد کنید">
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="email"><span>ایمیل: </span> <span>{{ $tcInfo->user->email }}</span></label>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="phone"><span>موبایل: </span> <span>{{ $tcInfo->user->phone }}</span></label>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="block2" name="block" value="1"
                                                           class="custom-control-input @error('block') is-invalid @enderror" {{ $tcInfo->user->block == 1 ? 'checked' : '' }}>
                                                    <label class="custom-control-label" for="block2">فعال</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" id="block3" name="block" value="0"
                                                           class="custom-control-input @error('block') is-invalid @enderror" {{ $tcInfo->user->block == 0 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="resume"
                                                              ...
                                                              name="resume"
                                                              placeholder="رزومه را وارد کنید">{{ old('resume',$tcInfo->resume) }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
