...
@section('page_title')افزودن کلاس@endsection
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">فرم افزودن کلاس جدید</li>
                        </ol>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> فرم کلاس</h4>
