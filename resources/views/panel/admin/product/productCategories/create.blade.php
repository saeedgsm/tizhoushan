...
@section('page_title')افزودن دسته بندی محصول@endsection
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">فرم افزودن دسته بندی محصول جدید</li>
                        </ol>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> فرم افزودن دسته بندی محصول</h4>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select autofocus class="form-control  @error('parent_id') is-invalid @enderror" name="parent_id" id="parent_id">
                                                    ...
                                                    @foreach($parentCategories as $parent)
                                                        <option value="{{ $parent->id }}" style="height: 40px">{{ $parent->product_category_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text"
                                                   ...
                                                   value="{{ old('product_category_latin') }}"
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <input type="number"
                                                   ...
                                                   value="{{ old('product_category_order') }}"
