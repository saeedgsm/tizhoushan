...
@section('page_title')ویرایش محصول @endsection

@section('script')
    <script>
        $(document).ready(function () {
            let price = document.querySelector('#price');
            let product_type_payment = "{{ $product->product_type_payment }}";
            console.log(product_type_payment)
            if (product_type_payment === 'cash'){
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">فرم ویرایش محصول </li>
                        </ol>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> فرم ویرایش محصول</h4>
                                    ...
                                    <div class="row">
                                                    ...
                                                    @foreach($parentCategories as $parent)
                                                        ...
                                                        @if($children = $parent->childrenCategories()->get())
                                                            @foreach($children as $sub)
                                                                <option value="{{ $sub->id }}"  {{ in_array(trim($sub->id), $product->productCategory->pluck('id')->toArray()) ? 'selected' : '' }}>  --  {{ $sub->product_category_name }}</option>
                                                            @endforeach
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text"
                                                   class="form-control"
                                                   name="product_latin"
                                                   value="{{ old('product_latin',$product->product_latin) }}"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <input type="text"
                                                   class="form-control"
                                                   name="product_label"
                                                   value="{{ old('product_label',$product->product_label) }}"
                                        ...
                                        <div class="col-md-12 mb-3">
                                            ...
                                            <textarea type="text"
                                                      ...
                                                      name="product_body"
                                                      rows="8"
                                                      id="product_body" placeholder="توضیحات محصول را وارد کنید">{{ old('product_body',$product->product_body) }}</textarea>
                                            @error('error')
                                            <ul class="parsley-errors-list is-invalid"
                                                id="parsley-id-5" aria-hidden="false">
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_type2" name="product_type" value="physical"
                                                       class="custom-control-input @error('product_type') is-invalid @enderror" {{ $product->product_type == 'physical' ? 'checked' : '' }}>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_type3" name="product_type" value="virtual"
                                                       class="custom-control-input @error('product_type') is-invalid @enderror" {{ $product->product_type == 'virtual' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-3 mb-3">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_status2" name="product_status" value="1"
                                                       class="custom-control-input @error('product_status') is-invalid @enderror" {{ $product->product_status == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_status3" name="product_status" value="0"
                                                       class="custom-control-input @error('product_status') is-invalid @enderror" {{ $product->product_status == 0 ? 'checked' : '' }}>
                                        ...
                                        <div class="col-lg-2 mb-3">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_type_payment1" name="product_type_payment"
                                                       value="free"
                                                       class="custom-control-input" {{ $product->product_type_payment == 'free' ? 'checked' : '' }}>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="product_type_payment2" name="product_type_payment" value="cash"
                                                       class="custom-control-input" {{ $product->product_type_payment == 'cash' ? 'checked' : '' }}>
