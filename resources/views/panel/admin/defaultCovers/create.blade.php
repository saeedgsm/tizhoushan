...
@section('page_title')افزودن کاور پیش فرض@endsection
                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active">فرم افزودن کاور پیش فرض</li>
                        </ol>
                    </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> فرم افزودن کاور پیش فرض</h4>
                                <p class="card-title-desc">
                                    @include('alert_messages.alerts')
                                </p>
                                <form action="{{ route('admin.defaultCovers.store') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="cover_loc"><span>قسمت مورد استفاده </span> <span class="text-danger">به لاتین</span></label>
                                            <input type="text"
                                                   class="form-control"
                                                   name="cover_loc"
                                                   value="{{ old('cover_loc') }}"
                                            ...
                                            <ul class="parsley-errors-list is-invalid"
                                                id="parsley-id-5" aria-hidden="false">
                                                <li class="parsley-required">قسمت مورد استفاده به لاتین را وارد کنید</li>
                                            </ul>
                                            @enderror
                                        </div>
