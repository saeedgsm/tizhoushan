...
<head>
    ...
    *************************************-->
    ...
    <link rel="stylesheet" href="/assets/store/css/fontawesome.min.css" />
    <link rel="stylesheet" href="/assets/store/css/ionicons.min.css" />
    <link rel="stylesheet" href="/assets/store/css/simple-line-icons.css" />
    <link rel="stylesheet" href="/assets/store/css/plugins/jquery-ui.min.css">
    <link rel="stylesheet" href="/assets/store/css/bootstrap.min.css" />
    <link rel="stylesheet" href="/assets/store/css/app-rtl.min.css" />
    <link rel="stylesheet" href="/assets/store/css/plugins/plugins.css" />
    <!-- <link rel="stylesheet" href="/assets/store/css/plugins/aos.css" /> -->
    ...
    ****************************-->
     ...
     ***********************************************-->
    <!-- <link rel="stylesheet" href="/assets/store/css/vendor/vendor.min.css" />
    <link rel="stylesheet" href="/assets/store/css/plugins/plugins.min.css" />
                        ...
                        <div class="product-sync-init mb-20">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="/assets/store/img/slider/thumb/1.jpg"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="/assets/store/img/slider/thumb/2.jpg"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="/assets/store/img/slider/thumb/3.jpg"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <img
                                        src="/assets/store/img/slider/thumb/4.jpg"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                        ...
                        <div class="product-sync-nav">
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)">
                                        <img
                                            src="/assets/store/img/slider/thumb/1.1.jpg"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)">
                                        <img
                                            src="/assets/store/img/slider/thumb/2.1.jpg"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"
                                    ><img
                                            src="/assets/store/img/slider/thumb/3.1.jpg"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
                            ...
                            <div class="single-product">
                                <div class="product-thumb">
                                    <a href="javascript:void(0)"
                                    ><img
                                            src="/assets/store/img/slider/thumb/4.1.jpg"
                                            alt="product-thumb"
                                        /></a>
                                </div>
                            </div>
...
<script src="/assets/store/js/vendor/jquery-3.5.1.min.js"></script>
<script src="/assets/store/js/vendor/modernizr-3.7.1.min.js"></script>
<script src="/assets/store/js/popper.min.js"></script>
<script src="/assets/store/js/plugins/jquery-ui.min.js"></script>
<script src="/assets/store/js/bootstrap.min.js"></script>
<script src="/assets/store/js/plugins/plugins.js"></script>
<script src="/assets/store/js/plugins/ajax-contact.js"></script>
<!-- <script src="/assets/store/js/plugins/aos.js"></script> -->
...
<!-- <script src="/assets/store/js/vendor/vendor.min.js"></script>
    <script src="/assets/store/js/plugins/plugins.min.js"></script>
    <script src="/assets/store/js/main.js"></script> -->
