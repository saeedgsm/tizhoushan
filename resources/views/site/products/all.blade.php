                                            ...
                                            <div class="card-body">
                                                <div class="product-thumbnail position-relative">
                                                    ...
                                                    <a href="single-product.html">
                                                        <img
                                                            class="first-img"
                                                            src="{{ asset($product->product_image) }}" alt="thumbnail"/>
                                                    </a>
                                                    <!-- product links -->
                                                    <ul class="actions d-flex justify-content-center">
                                                        <li><a class="action"
                                                               href="{{ route('site.products.show',$product) }}">
                                                            <span data-toggle="tooltip" data-placement="bottom"
                                                                  title="به علاقه مندی اضافه کن"
                                                                  class="icon-heart"
                                                            >
                            </span>
                                                            </a>
                                                ...
                                                <div class="product-desc py-0 px-0">
                                                    <h3 class="title">
                                                        <a href="{{ route('site.products.show',$product) }}">{{ $product->product_name }}</a>
                                                    </h3>
                                                    ...
                                                    >
                                                        <span class="product-price">{{ $product->product_price }} <span>تومان</span></span>
                                                        <button
                                                            class="pro-btn"
                                                            data-toggle="modal"
                    ...
                    <aside class="left-sidebar theme1">
                        ...
                        <div class="banner hover-animation position-relative overflow-hidden">
                            <a href="shop-grid-4-column.html" class="d-block">
                                <img src="/assets/store/img/banner/2.jpg" alt="img"/>
                            </a>
                        </div>
                        <!--second banner end-->
                    </aside>
